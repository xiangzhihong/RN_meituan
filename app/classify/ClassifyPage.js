...
import ShopBar from '../classify/ShopBar'
    ...
    render() {
        ...
        return (
            <View style={{flex: 1, backgroundColor: "#f3f3f3"}}>
                <Animated.Image source={require('../images/categer_bg.jpg')} ref={'backgroundImage'}
                ...
                <NavigationBar
                    ...
                    leftButton={ViewUtils.getLeftCircleButton(() => this.props.navigator.pop())}
                />
